...
<template>
  <div class="card justify-center w-52 h-screen bg-white shadow-md fixed top-0 left-0 flex">
    <Menu :model="items" class="w-full md:w-60">
      <template #start>
        <span class="flex items-center justify-start gap-2 p-2 pl-10 mb-3 h-10 mt-6">
          <i class="pi pi-objects-column" />
          <span class="text-xl font-semibold"><span class="text-primary">User Panel</span></span>
        </span>
        <Divider />
        <button v-ripple
          ...
          <Avatar image="https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png"
            class="mr-2 self-center min-w-8" shape="circle" />
          <span class="inline-flex flex-col items-start">
            <span class="font-bold truncate" v-if="activeUser && activeUser.name">{{ activeUser?.name.slice(0, 12)
              }}...</span>
...
<!--   <div class="flex"> -->
<!--     <!-- Sidebar --> -->
<!--     <aside class="w-52 h-screen bg-white shadow-md fixed top-0 left-0 flex flex-col px-4 py-6 space-y-4"> -->
...
<!--       <!--   <router-link :to="link.to" class="py-2 px-3 rounded-md text-gray-700 hover:bg-blue-100 hover:text-blue-600" -->
-->
<!--       <!--     :class="{ 'bg-blue-100 text-blue-600': isActive(link.to) }"> --> -->
<!--       <!--     {{ link.text }} --> -->
<!--       <!--   </router-link> --> -->
<!--       <!-- </div> --> -->
<!--     </aside> -->
