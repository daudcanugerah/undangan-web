  ...
  // import UpdateDialog from '@/pages/admin/user-manager/UpdateDialog.vue';
  ...
  const dt = ref();
  const { list: userList } = storeToRefs(userManagerStore)
  ...
  <template>
    ...
    <div class="card overflow-scroll w-full p-10">
      ...
      <DataTable ref="dt" v-model:selection="selectedUserManagers" :value="userList" dataKey="id" :paginator="true"
